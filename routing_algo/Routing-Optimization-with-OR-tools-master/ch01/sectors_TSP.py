...
# [START program]
"""Simple Travelling Salesperson Problem (TSP) between sectors."""
...
def create_distance_matrix():
    ...
    #     if index % 2 != 0:
    #         data[index] = [item * 100 for item in value]
    ...
    #                             [24.472863, 54.350427],
    # ]
    ctys = ['E40', 'E1', 'E5', 'W10', 'W6', 'W9', 'E4Q1', 'EQ21', 'E1Q5', 'W1QQ1', 'W2Q', 'WQ3']
    df = pd.DataFrame(data, columns=['xcord', 'ycord'], index=ctys)
    # print(df.values)
    dm = pd.DataFrame(distance_matrix(df.values, df.values), index=df.index, columns=df.index)
    dm = dm * 1000
    # pd.DataFrame(dm).astype(int).to_csv("file.csv")
...
def create_data_model():
    ...
    data['distance_matrix'] = [
        [
            0, 1000, 776, 696, 582, 274, 502, 194, 308, 194, 536, 502, 388, 354,
            468, 776, 662
        ],
        [
