...
"""
for r_index, row in enumerate(data['distance_matrix']):
    for c_index, column in enumerate(row):
        if r_index == c_index or (is_entry(r_index) and (c_index - r_index) == 1):
         ...
         #Exit
            ...
            pass
        # elif not is_entry(c_index) and (r_index - c_index) % 2 == 1 and (r_index - c_index) > 0:
        #     pass
        else:
            data['distance_matrix'][r_index][c_index] = 1e6
